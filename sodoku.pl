...
solve(Board) :-
        ...
        AllColumns = [Col0, Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8],
        AllCubes = [Cube0, Cube1, Cube2, Cube3, Cube4, Cube5, Cube6, Cube7, Cube8],

        %Board = AllRows

        outerLoop(AllCubes, AllColumns, Board, 0),
        outerLoop(AllCubes, AllColumns, Board, 1),
        outerLoop(AllCubes, AllColumns, Board, 2),
        outerLoop(AllCubes, AllColumns, Board, 3),
        outerLoop(AllCubes, AllColumns, Board, 4),
        outerLoop(AllCubes, AllColumns, Board, 5),
        outerLoop(AllCubes, AllColumns, Board, 6),
        outerLoop(AllCubes, AllColumns, Board, 7),
        outerLoop(AllCubes, AllColumns, Board, 8).


outerLoop(AllCubes, AllColumns, Board, Num) :-
        innerLoop(AllCubes, AllColumns, Board, Num, 0),
        innerLoop(AllCubes, AllColumns, Board, Num, 1),
        innerLoop(AllCubes, AllColumns, Board, Num, 2),
        innerLoop(AllCubes, AllColumns, Board, Num, 3),
        innerLoop(AllCubes, AllColumns, Board, Num, 4),
        innerLoop(AllCubes, AllColumns, Board, Num, 5),
        innerLoop(AllCubes, AllColumns, Board, Num, 6),
        innerLoop(AllCubes, AllColumns, Board, Num, 7),
        innerLoop(AllCubes, AllColumns, Board, Num, 8).


innerLoop(AllCubes, AllColumns, Board, RowIndex, ColumnIndex) :-
        nth0(RowIndex, Board, RowContent),
        nth0(ColumnIndex, AllColumns, ColumnContent),

        cubeNum(RowIndex, ColumnIndex, Cube),
        nth0(Cube, AllCubes, CubeContent),

        nth0(ColumnIndex, RowContent, Spot),
        nth0(RowIndex, ColumnContent, Spot),

        (nonvar(Spot) ;
        var(Spot), digit(Spot), is_set(RowContent), is_set(ColumnContent),
        is_set(CubeContent)).
